...
if __name__ == '__main__':
    ...
    saved_state_dict = torch.load(model_dir + '/'+"2DASL_checkpoint_epoch_allParams_stage2.pth.tar")
    state_dict = saved_state_dict['res_state_dict']
    model.load_state_dict(state_dict)
    model.cuda(0)
   
    # Load Testset
    testset = pretreat_img(data_dir)
